...
/*package*/ class Transition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_jj4qz_a0(editorContext, node);
  ...
  public Grid createStaticHorizontal_jj4qz_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(3);
    if (true) {
      children.add(createTableCell_jj4qz_a0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_jj4qz_b0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_jj4qz_c0a(editorContext, node));
    }
  ...
  public Grid createTableCell_jj4qz_a0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createHeaderReference_jj4qz_a0a0(editorContext, node));

    return grid;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.target$$6wD;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.target$$6wD);
    }
  ...
  public HeaderGrid createHeaderReference_jj4qz_a0a0(final EditorContext editorContext, final SNode snode) {
    HeaderGrid hgrid = new HeaderGrid();
    hgrid.setElement(0, 0, new StringHeaderReference("Target State"));
    return hgrid;
  }
  public Grid createTableCell_jj4qz_b0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createHeaderReference_jj4qz_a1a0(editorContext, node));
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.input$zU4O;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no input>");
  ...
  public HeaderGrid createHeaderReference_jj4qz_a1a0(final EditorContext editorContext, final SNode snode) {
    HeaderGrid hgrid = new HeaderGrid();
    hgrid.setElement(0, 0, new StringHeaderReference("Input"));
    return hgrid;
  }
  public Grid createTableCell_jj4qz_c0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createHeaderReference_jj4qz_a2a0(editorContext, node));
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.output$$0qf;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  public HeaderGrid createHeaderReference_jj4qz_a2a0(final EditorContext editorContext, final SNode snode) {
    HeaderGrid hgrid = new HeaderGrid();
    hgrid.setElement(0, 0, new StringHeaderReference("Output"));
    return hgrid;
  }
